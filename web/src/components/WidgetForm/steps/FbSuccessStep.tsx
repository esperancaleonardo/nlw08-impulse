...
interface FbSuccessStepProps {
  onFeedbackRestart: () => void;
}

export function FbSuccessStep({ onFeedbackRestart }: FbSuccessStepProps) {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-xl mt-2">Agradecemos a sua mensagem!</span>
        <button
          type="button"
